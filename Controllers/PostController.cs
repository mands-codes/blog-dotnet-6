...
namespace Blog.Controllers
{
    ...
    public class PostController : ControllerBase
    {
        ...
        public async Task<IActionResult> GetAsync([FromServices] BlogDataContext context, [FromQuery] int page = 0, [FromQuery] int pageSize = 25)
        {
            ...
            {
                return StatusCode(500, new ResultViewModel<Post>("05X30 - Falha interna do servidor."));
            }
        }

        [HttpGet("v1/posts/detail/{id:int}")]
        public async Task<IActionResult> GetDetailsAsync([FromServices] BlogDataContext context, [FromRoute] int id)
        {
            try
            {
